...
def move_relative_to_cube(robot: cozmo.robot.Robot):
	...
	desired_pose_relative_to_cube = Pose(0, -110, 0, angle_z=degrees(90))
	...
	# ####
	new_pose = get_relative_pose(cube.pose, robot.pose) + desired_pose_relative_to_cube
	my_go_to_pose1(robot, new_pose.position.x, new_pose.position.y, new_pose.rotation.angle_z.degrees)
